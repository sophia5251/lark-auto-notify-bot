...
//SELL https://open.larksuite.com/open-apis/bot/v2/hook/79bfd342-***-***
//BUY https://open.larksuite.com/open-apis/bot/v2/hook/e7b3931f-******c
    ...
    const req = https.request(options, (res) => {
      ...
      res.on('end', () => {
        ...
        if (jsonData.msg === 'success') {
          ...
          log('Message Send Failed', jsonData.msg);
        }
      });
    });
